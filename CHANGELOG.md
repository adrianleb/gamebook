...
- Act 3 Ending Branch 2: The Open Book nodes 345-348: Breaking the Binding ending approach (345), The Doors Open transition with BOUNDARY_DISSOLVED flag (346), A World Rewritten ending beat (347), Open Book Resolution conclusion with ENDING_OPEN_BOOK flag (348) — Exiter-aligned ending complete (PR #211)
- Act 3 Ending Branch 3: The Closed Canon nodes 349-351: Sealing the Passage ending approach (349), The Final Curtain transition with ally farewells (350), Closed Canon Resolution conclusion with ENDING_CLOSED_CANON flag (351) — Preservationist-aligned ending complete (PR #216)
